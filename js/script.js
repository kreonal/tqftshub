                ...
                card.innerHTML = `
                    ...
                    <div class="card-right">
                        ...
                        <div class="card-right-details">
                            <p>Change: ${team["Power Ranking Change"]}<br>Record: ${team.Wins}-${team.Losses}<br>Avg Points: ${team["AVG POINTS"]}</p>
                            <p>Scoring Rank: ${ordinalSuffix(team["Scoring Rank"])}<br>Consistency Rank: ${ordinalSuffix(team["Consistency Rank"])}<br>Roster Rank: ${ordinalSuffix(team["Roster Rank"])}</p>
                        </div>
